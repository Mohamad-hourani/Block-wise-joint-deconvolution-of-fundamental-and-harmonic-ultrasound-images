...
%% Presenting inputs
figure,
subplot(121),imagesc(rf2bmode(y1,0.1));colormap(gray);title('Fundamental ultrasound image')
subplot(122),imagesc(rf2bmode(y2,0.1));colormap(gray);title('Harmonic ultrasound image Image (with attenuation)')
...
load('x_joint.mat');
figure,subplot(121),imagesc(rf2bmode(x_joint_spatially,0.1)),colormap('gray')
subplot(122),imagesc(rf2bmode(x_joint,0.1)),colormap('gray')
%% Profile horizantal
xxx=1:384;
% PSF1
 figure,plot(rf2bmode(x_joint(512,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(512,:),0.1)),legend
w11=fwhm(xxx,rf2bmode(x_joint(512,:),0.1));
w12=fwhm(xxx,rf2bmode(x_joint_spatially(512,:),0.1));
%PSF2
 figure,plot(rf2bmode(x_joint(1085,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(1085,:),0.1)),legend
w21=fwhm(xxx,rf2bmode(x_joint(1085,:),0.1));
w22=fwhm(xxx,rf2bmode(x_joint_spatially(1085,:),0.1));
%PSF3
 figure,plot(rf2bmode(x_joint(1622,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(1622,:),0.1)),legend
w31=fwhm(xxx,rf2bmode(x_joint(1622,:),0.1));
w32=fwhm(xxx,rf2bmode(x_joint_spatially(1622,:),0.1));
%PSF4
figure,plot(rf2bmode(x_joint(2139,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(2139,:),0.1)),legend
w41=fwhm(xxx,rf2bmode(x_joint(2139,:),0.1));
w42=fwhm(xxx,rf2bmode(x_joint_spatially(2139,:),0.1));
%PSF5
figure,plot(rf2bmode(x_joint(2674,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(2674,:),0.1)),legend
w51=fwhm(xxx,rf2bmode(x_joint(2674,:),0.1));
w52=fwhm(xxx,rf2bmode(x_joint_spatially(2674,:),0.1));
%PSF6
figure,plot(rf2bmode(x_joint(3157,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(3157,:),0.1)),legend
w61=fwhm(xxx,rf2bmode(x_joint(3157,:),0.1));
w62=fwhm(xxx,rf2bmode(x_joint_spatially(3157,:),0.1));
%PSF7
figure,plot(rf2bmode(x_joint(3664,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(3664,:),0.1)),legend
w71=fwhm(xxx,rf2bmode(x_joint(3664,:),0.1));
w72=fwhm(xxx,rf2bmode(x_joint_spatially(3664,:),0.1));
%PSF8
figure,plot(rf2bmode(x_joint(4147,:),0.1))
, hold on, plot(rf2bmode(x_joint_spatially(4147,:),0.1)),legend
w81=fwhm(xxx,rf2bmode(x_joint(4147,:),0.1));
w82=fwhm(xxx,rf2bmode(x_joint_spatially(4147,:),0.1));
wjointspatially= [w12 w22 w32 w42 w52 w62 w72 w82];
wjoint= [w11 w21 w31 w41 w51 w61 w71 w81];
figure,bar(abs(wjoint-wjointspatially));
% %% Profile vertical
% % PSF1
